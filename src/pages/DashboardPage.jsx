...
// États pour les données
    ...
    // ✅ AJOUT: État pour gérer la vue actuelle
// 'overview' ou 'applications'
            ...
            try {
                ...
                const applicationPromises = myJobs.slice(0, 5).map(async (job) => {
                    try {
                        ...
                        console.warn(`Cannot fetch applications for job ${job._id}:`, error.message);
                        return [];
                    }
                });
                ...
                console.warn('Cannot fetch applications data:', applicationsError.message);
    ...
    const generateRecentActivities = (applications, savedJobs) => {
        ...
        applications.slice(0, 3).forEach(app => {
            activities.push({
                id: app._id,
                type: 'application',
                message: `Applied to ${app.job?.title}`,
